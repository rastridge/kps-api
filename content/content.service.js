...
async function getAll() {
	const sql =
		'select content_id as id, content_name as title, modified_dt as dt, status, content_name, content_body, content_release_dt, content_expire_dt FROM inbrc_content WHERE deleted = 0'
...
async function getMenuItems() {
	...
	const sql =
		'select content_id as id, content_name as title, modified_dt as dt, status, content_name, content_body, content_release_dt, content_expire_dt FROM inbrc_content WHERE deleted = 0 AND status = 1'
	content = await doDBQuery(sql)
